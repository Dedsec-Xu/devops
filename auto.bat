...
powershell curl -o "xenial-server-cloudimg-amd64-vagrant-2.box" "https://app.vagrantup.com/ubuntu/boxes/xenial64/versions/20211001.0.0/providers/virtualbox.box"

vagrant box add .\xenial-server-cloudimg-amd64-vagrant-2.box --name assignment1
mkdir vagrant
cd vagrant
